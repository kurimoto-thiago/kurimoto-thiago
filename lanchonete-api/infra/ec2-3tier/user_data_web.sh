...
# ── Frontend (clona do repositório) ──────────────────────────────────────────
dnf install -y git
git clone https://github.com/kurimoto-thiago/kurimoto-thiago.git /tmp/repo
mkdir -p /usr/share/nginx/html/lanchonete
cp /tmp/repo/lanchonete-api/src/public/index.html /usr/share/nginx/html/lanchonete/index.html
rm -rf /tmp/repo

# ── (mantido para referência — HTML inline não mais necessário) ───────────────
: <<'HTML'
<!DOCTYPE html>
<html lang="pt-BR">
<head>
